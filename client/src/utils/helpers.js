...
export function idbPromise(storeName, method, object) {
  return new Promise((resolve, reject) => {
    ...
    //create variables to hold reference to the database, transactions 9tx), and object store
    let db, tx, store;

    //if version has changed (or if this is the first time using the database), run thid method and create the three object stores
